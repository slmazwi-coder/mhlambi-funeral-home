      ...
      <div className="min-h-screen pt-16 bg-muted">
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="max-w-2xl mx-auto">
            <h1 className="font-serif text-3xl md:text-4xl font-medium text-foreground mb-2">Membership Application</h1>
            <p className="text-muted-foreground text-sm mb-10">Complete the form below to join Mhlambi’s Funeral Home.</p>
            ...
            <form onSubmit={handleSubmit} className="p-8 rounded-xl bg-card shadow-card space-y-5">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-muted-foreground">
                  I consent to Mhlambi’s Funeral Home processing my personal information for membership purposes.
                </span>
              </label>
